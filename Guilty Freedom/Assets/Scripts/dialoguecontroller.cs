...
public class dialoguecontroller : MonoBehaviour
{
    ...
    void Update()
    {
        if (d1) {
            ...
            thing.idx = 0;
            thing.textSpeed = 0.1f;
            string[] temp = {"Psssssst...", "We can help you escape the plantation and gain your freedom", "First complete the platform level and get all of the coin bags in the neighboring village", "Touch the tree on the platform level to teleport to the village", "Good luck!"};
            thing.lines = temp;
            // thing.StartDialogue();
            dialogue.SetActive(true);
            d2 = false;
